...
| # | 제목 | 상태 | 날짜 |
| --- | --- | --- | --- |
| [0001](0001-node-granularity.md) | 노드를 얼마나 잘게 나눌까 = 개념/키워드 단위 | 일부 대체됨(→0013) | 2026-05-28 |
| [0002](0002-node-source.md) | 개념 점 출처 = 자동 추천 + 사람 확인 | 일부 대체됨(→0013) | 2026-05-28 |
...
| [0013](0013-bipartite-model-pivot.md) | 이분 그래프로 피벗 = 문서·개념 두 노드 + 자동 멤버십 엣지 | 채택 | 2026-06-12 |
| [0014](0014-persist-document-set.md) | DB 영속 대상 = 빌드된 그래프 대신 문서 집합(원천) | 채택 | 2026-06-12 |
...
## 다음 ADR 후보
- 개념 별칭/동의어 처리(②), 임베딩 기반 의미 유사도 — [0013] 보류분.
- 퀴즈에서의 LLM 연동 방식(가벼움 vs 무거움) — 능동 학습 단계 착수 시.
